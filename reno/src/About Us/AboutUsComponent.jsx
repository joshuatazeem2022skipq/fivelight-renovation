...
const services = [
  {
    ...
    description:
      "Our team consists of professional and certified designers who have years of experience in interior design. We ensure top-notch design solutions tailored to your preferences and needs.",
  },
  {
    icon: <CheckIcon sx={{ marginRight: 1, my: 1, color: "#8f6e45" }} />,
    heading: "Quality Material for Awesome Walls",
    description:
      "We prioritize quality materials to transform your walls into stunning masterpieces. From paints to wallpapers, we guarantee durable and visually appealing solutions for your space.",
  },
];
              ...
              <div>
                ...
                >
                  <Typography
                    variant="h6"
                    align="center"
                    sx={{ fontWeight: "bold", color: "#daaa5e" }}
                  >
                    We have 16+ years of experiences
                  </Typography>
                </Box>
                <Typography
                  variant="body1"
