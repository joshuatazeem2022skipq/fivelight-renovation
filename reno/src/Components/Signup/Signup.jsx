...
export default function Signup() {
  ...
  const saveUser = (data) => {
    ...
    console.log(data);
    axios
      .post("http://localhost:6073/create-user", data)
      .then(function (resp) {
        move("/admin/login");
  ...
  return (
    <>
      ...
      <div
        id="bg"
        className="min-h-screen flex flex-col justify-center bg-black text-white py-12 sm:px-6 lg:px-8"
      >
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          {/* <img
              ...
              alt="Workflow"
            /> */}
          <h2 className="mt-6 text-center text-3xl font-extrabold text-[#be9563]">
          ...
          <div className="bg-transparent py-8 px-4 shadow sm:rounded-lg sm:px-10">
            ...
            >
              <div>
                <label
                  htmlFor="name"
                  className="block text-sm font-medium text-[#be9563]"
                >
                  Username
                </label>
                <div className="mt-1">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <label
                    htmlFor="remember-me"
                    className="ml-2 block text-sm text-[#be9563]"
                  >
                    Remember me
                  </label>
                </div>
                ...
                <div className="text-sm">
                  <a
                    href="#f"
                    className="font-medium text-[#be9563]hover:text-indigo-500"
                  >
