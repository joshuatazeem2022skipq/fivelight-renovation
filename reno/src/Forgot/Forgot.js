...
export default function Forgot() {
  ...
  const findUser = (data) => {
    ...
    // useEffect(() => {
    axios.post("http://localhost:6073/forgot-password", data).then((resp) => {
  ...
  return (
    <>
      {/*
          ...
          ```
        */}
      <div className="!h-screen flex flex-col justify-center bg-black text-white py-12 sm:px-6 lg:px-8">
        <div className="sm:mx-auto sm:w-full sm:max-w-md">
          <h2 className="mt-6 text-center text-3xl font-extrabold text-amber-600">
            Forgot Password
          </h2>
          <p className="mt-2 text-center text-sm text-amber-600">
            <a href="/signup" className="font-sm text-indigo-300">
              Remeber your password: Login Now
            </a>
          </p>
        </div>
            ...
            >
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <label
                    htmlFor="remember-me"
                    className="ml-2 block text-sm text-amber-600"
                  >
                    Remember me
                  </label>
                </div>
